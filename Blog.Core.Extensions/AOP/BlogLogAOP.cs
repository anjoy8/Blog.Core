...
namespace Blog.Core.AOP
{
    ...
    public class BlogLogAOP : IInterceptor
    {
        ...
        public BlogLogAOP(IHubContext<ChatHub> hubContext, IHttpContextAccessor accessor, ILogger<BlogLogAOP> logger)
        {
        ...
        public void Intercept(IInvocation invocation)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _logger.LogInformation("AOPLog,{TraceIdentifier}: {ApiLogAopInfo}",
                        _accessor.HttpContext?.TraceIdentifier, JsonConvert.SerializeObject(apiLogAopInfo));
                }
            }
            ...
            {
                //发送日志
                _hubContext.Clients.All.SendAsync("ReceiveUpdate", JsonConvert.SerializeObject(apiLogAopInfo)).Wait();
            }
        }
        ...
        private void LogEx(Exception ex, AOPLogInfo dataIntercept)
        {
            if (ex != null)
            {
                ...
                // 异常日志里有详细的堆栈信息
                _logger.LogError(ex, "AOPLog,{TraceIdentifier}: {ApiLogAopInfo}",
                    _accessor.HttpContext?.TraceIdentifier, JsonConvert.SerializeObject(apiLogAopExInfo));
            }
        }
